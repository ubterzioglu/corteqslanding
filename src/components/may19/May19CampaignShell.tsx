...
const navButtonClass =
  "rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold text-slate-100 backdrop-blur transition hover:bg-white/20";
      ...
      <header className="relative overflow-hidden border-b border-orange-100 bg-[linear-gradient(135deg,#0f172a_0%,#1e293b_38%,#0b3f52_100%)] text-white">
        ...
        <div className="container relative mx-auto px-4 pb-12 pt-5 lg:px-6 lg:pb-16">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <Link
              to="/"
              className="inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/10 px-3 py-2 backdrop-blur transition hover:bg-white/15"
            >
              <img src={logo} alt="CorteQS" className="h-9 w-9 rounded-full bg-white object-contain p-1" />
              <span className="text-sm font-semibold tracking-wide text-slate-100">CorteQS</span>
            </Link>

            <div className="flex flex-wrap items-center gap-2">
              <Link to="/19051919" className={navButtonClass}>
                19 Mayıs Ana Sayfa
              </Link>
              <Link to="/19051919/harita" className={navButtonClass}>
                Harita
              </Link>
            </div>
          </div>
