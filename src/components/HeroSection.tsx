...
const HeroSection = () => {
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-4rem)] items-center overflow-hidden bg-gradient-to-br from-background via-card to-secondary/30 pt-4 lg:pt-5">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1780px] px-4 py-7 md:px-6 md:py-8 2xl:px-10">
