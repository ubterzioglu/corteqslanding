...
const DEMO_POSTS: CaddePost[] = [
  {
    ...
    commentCount: 2,
    comments: [
      { id: "demo-comment-1", postId: "demo-post-1", userId: "demo", body: "Berlin product meetup'larını paylaşabilirim.", authorName: "Mert Koca", createdAt: "2026-05-28T12:00:00.000Z" },
