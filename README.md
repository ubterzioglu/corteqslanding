...
- The admin shell links the external dashboard's merged meeting workflow through `Toplantılar / Aksiyonlar`; legacy `TODO Listesi` and `Toplantı Özetleri` links remain temporarily available during migration.
